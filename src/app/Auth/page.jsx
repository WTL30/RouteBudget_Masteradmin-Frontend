...
const AuthPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await axios.post("https://masteradmin.routebudget.com/api/master/login-master-admin", {
        email,
        password,
      })
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      const res = await axios.post("https://masteradmin.routebudget.com/api/master/send-otp", {
        email: forgotEmail,
      })
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://masteradmin.routebudget.com/api/master/verify-otp", {
        email,
        otp,
      })
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("https://masteradmin.routebudget.com/api/master/reset-password", {
        email,
