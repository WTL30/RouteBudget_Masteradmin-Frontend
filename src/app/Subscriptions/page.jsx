...
const SubscriptionsPage = () => {
  ...
  const fetchTrialSubscriptions = async () => {
    try {
      const response = await fetch('https://masteradmin.routebudget.com/api/admin/get-free-trial-subAdmins');
  ...
  const fetchPaidSubscriptions = async () => {
    try {
      const response = await fetch('https://masteradmin.routebudget.com/api/admin/get-paid-subAdmins');
      const data = await response.json();
